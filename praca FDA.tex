...
\begin{document}
	...
	\begin{uw}\cite{W}
		...
		\int_T  | \psi (t,s) | y (t)^q d\mu(t) \leq [a y (s) ]^q, \quad \quad \mu-\text{pr.w.}
		\end{equation}
		oraz
		\begin{equation}\label{eq:zal2}
		\int_T  | \psi (t,s) | y (t)^p d\mu(t) \leq [b y (s) ]^p, \quad \quad \mu-\text{pr.w.},
		\end{equation}
	...
	Podobnie jak w artykule \cite{K08} oraz ksi¹¿ce \cite{HK}, zastosujemy przedstawiony test do modelu stworzonego na podstawie danych opisuj¹cych pola magnetyczne. Takie dane zbierane s¹ przez stacje geofizyczne i publikowane s¹ w ramach miêdzynarodowego programu INTERMAGNET i udostêpniane s¹ na stronie internetowej projektu \cite{I}. Do programu nale¿y obecnie 129 naziemnych obserwatoriów, w tym dwie stacje znajduj¹ce siê w Polsce (mapa stacji na Rysunku \ref{fig:mapa})
	\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.88]{mapa_stacji.png}
		\caption{Mapa stacji geofizycznych nale¿¹cych do programu INTERMAGNET}
		\label{fig:mapa}
	\end{figure}
	% uaktualnic rysynek?
	\\Dane o polu magnetycznym zbierane s¹ za pomoc¹ tzw. magnetometru. Urz¹dzenie to odczytuje informacje... \textcolor{red}{[...]}
	\\Ze strony programu mo¿na pobraæ dane dok³adne: w odstêpach jednosekundowych lub uproszczone: w odstêpach jednominutowych (obserwacja jest œredni¹ z 60 sekund). W pracy wykorzystano dane uproszczone, mamy zatem 1440 punktów ka¿dego dnia (poza sytuacjami z brakiem czêœci danych), które wykorzystamy do stworzenia danych funkcjonalnych. Tym sposobem jeden dzieñ stanie siê jedn¹ obserwacj¹.
	\\\textcolor{red}{Magnetometer data... }
	\\\textcolor{red}{Zorze polarne + substorms (?)}
	...
	Do programu INTERMAGNET nale¿¹ tak¿e dwie polskie stacje geofizyczne: obserwatorium w Belsku oraz obserwatorium na Helu. Przeprowadzimy zatem podobna j.w. analizê dla pó³nocnej Europy.
	\\\textcolor{red}{[...]}
	%
	\appendix
	%
