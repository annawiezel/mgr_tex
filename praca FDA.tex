...
\begin{document}
	...
	\begin{tw}\label{T1} \cite{K08}, \cite{HK}
		\\Jeœli spe³nione s¹ H$_0$ i powy¿sze Za³o¿enia, to $\widehat{T}_N(p,q) \overset{d}{\longrightarrow}\chi^2_{pq} $ przy $N \rightarrow \infty$.
	\end{tw}
	%
	\begin{tw} \cite{K08}, \cite{HK}
